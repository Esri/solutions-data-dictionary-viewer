...
var EditableText = /** @class */ (function (_super) {
    ...
    EditableText.prototype.maybeRenderInput = function (value) {
        ...
        return multiline ? (React.createElement("textarea", tslib_1.__assign({ ref: this.refHandlers.input }, props))) : (React.createElement("input", tslib_1.__assign({ ref: this.refHandlers.input, type: "text" }, props)));
    };
